...
#[derive(Debug, Clone)]
pub struct ReluNormalizeGateVariant<
...
impl<
        ...
        const LENGTH: usize,
        const K: usize,
    > GateOuputVariant<F, D, BASE, LENGTH> for ReluNormalizeGateVariant<F, D, BASE, LENGTH, K>
{
    fn id() -> String {
        format!("ReluNormalize<BASE={}, LENGTH={}, K={}>", BASE, LENGTH, K)
    }
    ...
    fn output_constraint(
        ...
        bit_sign * (output - trunc_sum) + (constant_one - bit_sign) * output
    }
