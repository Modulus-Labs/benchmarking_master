...
impl SafeMemory {
    ...
    pub fn new(memory: Memory, n32: usize, prime: BigInt) -> Self {
        ...
        let short_min = 
            BigInt::from_str("16798108731015832284940804142231733909889187121439069848933715426072753864723").unwrap() - &short_max;
    ...
    pub fn read_big(&self, ptr: usize, num_bytes: usize) -> Result<BigInt> {
        ...
        let big = BigInteger256::deserialize_with_mode(&mut buf, Compress::No, Validate::No).unwrap();
